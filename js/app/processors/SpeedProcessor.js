class SpeedProcessor extends FuzzySystemProcessor {
    constructor(defs, properties, system, linguisticVariable, term, rule) {
        ...
        this.PRODUCTIVITY = new linguisticVariable('Продуктивність', [0, 100])
        ...
        this.PRODUCTIVITY.addTerm(new term('Погано', 'trapeze', [0,0,30,40]));
        this.PRODUCTIVITY.addTerm(new term('Добре', 'trapeze', [30,40,70,80]));
        this.PRODUCTIVITY.addTerm(new term('Відмінно', 'trapeze', [70,80,100,100]));
